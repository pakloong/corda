 ...
 */
@VisibleForTesting
class AMQPBridgeManager(config: NodeSSLConfiguration, private val maxMessageSize: Int, val artemisMessageClientFactory: () -> ArtemisSessionProvider) : BridgeManager {
